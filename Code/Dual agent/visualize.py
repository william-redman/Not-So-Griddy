...
def compute_ratemaps(model, trajectory_generator, options, res=20, n_avg=None, Ng=512, idxs=None, all_activations_flag=False):
...
def compute_ratemaps_single_agent(model, trajectory_generator, options, res=20, n_avg=None, Ng=512, idxs=None):
    '''Compute spatial firing fields'''
...
def compute_relative_ratemaps(model, trajectory_generator, options, res=20, n_avg=None, Ng=512, idxs=None, all_activations_flag=False):
    '''Compute spatial firing fields'''
    ...
    for index in range(n_avg):
        ...
        pos_batch = pos_batch[:, :, :2] - pos_batch[:, :, 2:] 
        pos_batch = np.reshape(pos_batch.cpu(), [-1, 2])
        g_batch = g_batch[:,:,idxs].reshape(-1, Ng)
...
def compute_other_agent_ratemaps(model, trajectory_generator, options, res=20, n_avg=None, Ng=512, idxs=None, all_activations_flag=False):
    '''Compute spatial firing fields, but plotting based on second agent'''
