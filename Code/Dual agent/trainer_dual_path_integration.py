...
class Trainer(object):
    ...
    def train_step(self, inputs, pc_outputs, pos, step_idx):
        ''' 
        ...
        loss, err = self.model.compute_loss(inputs, pc_outputs, pos, step_idx)
    ...
    def train(self, n_epochs: int = 1000, n_steps=10, save=True):
        ...
        for epoch_idx in range(n_epochs):
            for step_idx in range(n_steps):
                ...
                loss, err = self.train_step(inputs, pc_outputs, pos, step_idx)
