...
training_loss = np.nan * np.zeros([2, n_seeds, 200]) # number of network types x number of seeds x number of time steps with saved loss and decoding error
decoding_error = np.nan * np.zeros([2, n_seeds, 200])
...
# Plotting
fig = plt.figure()
plt.fill_between(np.arange(0, 100, 0.5),  np.nanmin(training_loss[0, :, :], axis = 0), np.nanmax(training_loss[0, :, :], axis = 0), alpha=0.5, color = [0, 0.5, 0])
plt.plot(np.arange(0, 100, 0.5), np.nanmean(training_loss[0, :, :], axis = 0), '-', color = [0, 0.5, 0],  label = 'Single agent: reg. $10^{-7}$')
plt.legend()
...
fig = plt.figure()
plt.fill_between(np.arange(0, 100, 0.5),  np.nanmin(training_loss[1, :, :], axis = 0), np.nanmax(training_loss[1, :, :], axis = 0), alpha=0.5, color = [0.8, 0.3, 0.2])
plt.plot(np.arange(0, 100, 0.5), np.nanmean(training_loss[1, :, :], axis = 0), '-', color = [0.8, 0.3, 0.2], label = 'Dual agent: reg. $10^{-7}$')
plt.legend()
plt.ylabel('Training loss')
plt.xlabel('Epochs')
if save_flag:
...
fig = plt.figure()
plt.fill_between(np.arange(0, 100, 0.5),  np.nanmin(decoding_error[0, :, :], axis = 0), np.nanmax(decoding_error[0, :, :], axis = 0), alpha=0.5, color = [0, 0.5, 0])
plt.plot(np.arange(0, 100, 0.5), np.nanmean(decoding_error[0, :, :], axis = 0), '-', color = [0, 0.5, 0], label = 'Single agent: reg. $10^{-7}$')
plt.fill_between(np.arange(0, 100, 0.5),  np.nanmin(decoding_error[1, :, :], axis = 0), np.nanmax(decoding_error[1, :, :], axis = 0), alpha=0.5, color = [0.8, 0.3, 0.2])
plt.plot(np.arange(0, 100, 0.5), np.nanmean(decoding_error[1, :, :], axis = 0), '-', color = [0.8, 0.3, 0.2], label = 'Dual agent: reg. $10^{-7}$')
plt.legend()
